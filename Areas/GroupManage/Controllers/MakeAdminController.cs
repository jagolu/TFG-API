    ...
    public class MakeAdminController : ControllerBase
    {
        ...
        public IActionResult makeAdmin([FromBody] MakeAdmin_blockUser order)
        {
            ...
            try
            {
                ...
                Home.Util.GroupNew.launch(targetUser.User, group, null, Home.Models.TypeGroupNew.MAKE_ADMIN_USER, order.make_unmake, _context);
                Home.Util.GroupNew.launch(targetUser.User, group, null, Home.Models.TypeGroupNew.MAKE_ADMIN_GROUP, order.make_unmake, _context);
